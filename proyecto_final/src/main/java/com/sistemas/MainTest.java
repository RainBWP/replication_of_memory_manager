...
// Archivo de pruebas simples, pero que muestra que sí funciona
// la traducción conectando dos tipos de objetos
...
public class MainTest {
    public static void main(String[] args) {
        ...
        int df = Memoria_Traductor.convertir_virtual_a_fisica(192, tamano_de_pagina, entries);
        System.out.println("El valor de la dirección física es: "+df);
    }
}
